  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        alert("Verifique o seu email para confirmar a criação da conta.");
        navigate('/login');
      }
    } catch (err) {
    ...
    <div className="flex items-center justify-center h-full w-full bg-gray-50 dark:bg-darkBackground px-4">
      ...
      >
        ...
        <h2
          ...
          "
        >
          ⚠️ Após efetuar o registo, verifique a pasta de spam ou lixo eletrónico caso não encontre o email de verificação.
        </h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition text-sm disabled:opacity-50"
          >
