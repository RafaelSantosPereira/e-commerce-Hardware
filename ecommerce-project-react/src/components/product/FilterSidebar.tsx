...
function FilterSidebar({
  ...
  return (
    <div className="w-52 mr-5 p-5 bg-white dark:bg-darkSurface border rounded-lg shadow max-h-fit">
      ...
      <div className="mb-4">
        <button
          ...
          className="flex items-center justify-between gap-2 text-left text-lg font-medium mb-2 w-full"
        >
          <span>Marca</span>
