...
function Detail() {
  ...
  const handleAddToCart = async () => {
    try {
      await addToCart(Number(id), quantity); // usa a função do contexto
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-white dark:bg-[#1f1f1f] rounded-xl shadow-md p-6">
          <img
            ...
            className="w-full border-0 rounded-xl dark:border-gray-700"
          />
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="border-t border-gray-300 dark:border-gray-700 pt-4">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              {data.product.description || "Este produto é de alta qualidade e desempenho."}
            </p>
          </div>
